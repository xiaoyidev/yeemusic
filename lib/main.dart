...
class _MyAppState extends State<MyApp> {
  Locale _locale = const Locale('en', 'vi');
  ...
  void initState() {
    ...
    if (ConstantCodes.languageCodes.values.contains(systemLangCode)) {
      ...
      final String lang = Hive.box('settings')
          .get('lang', defaultValue: 'Vietnamese') as String;
      _locale = Locale(ConstantCodes.languageCodes[lang] ?? 'vi');
    }
